...
const BASE_URL = "https://kiral-oyun.lovable.app";
    ...
    handlers: {
      GET: async () => {
        const entries: SitemapEntry[] = [
          ...
          { path: "/oyunlar", changefreq: "weekly", priority: "0.9" },
          { path: "/solo", changefreq: "weekly", priority: "0.8" },
          { path: "/nasil-oynanir", changefreq: "monthly", priority: "0.7" },
